...
import heroVideo from '../assets/hero video/download.png';
...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative w-full h-screen overflow-hidden bg-black">
      <img src={heroVideo} className="absolute top-0 left-0 w-full h-full object-cover z-0" alt="Creative digital marketing portfolio backdrop" />
      <div className="absolute inset-0 bg-gradient-to-r from-black/30 via-black/20 to-black/40 z-10 pointer-events-none" />
      ...
      <div className="absolute inset-0 z-20 px-6 md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-center md:justify-between items-start text-left w-full h-full pt-28 md:pt-[12%]">
        <div className="flex flex-col items-start text-left max-w-lg lg:max-w-xl w-full">
          ...
          >
            Senior Content Writer | Digital Marketing Executive | Social Media Strategist | Videographer | Creative Producer
          </p>
          ...
          >
            I create compelling brand stories, high-performing social campaigns, and engaging short-form content that drives visibility and growth.
          </p>
