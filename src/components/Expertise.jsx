      ...
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        <div data-aos="fade-up" className="md:absolute top-10 left-0 md:w-[450px] z-20 mb-16 md:mb-0">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 leading-[1.1] mb-6 tracking-tight relative">
            Content, Strategy, and Creative Production for Brands
          ...
          <p className="text-gray-500 text-base md:text-lg max-w-sm font-medium leading-relaxed">
            I blend storytelling, social media strategy, and high-quality production to create campaigns that look good and perform even better.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          <TagCard number="01" title="Content Strategy" text="Building brand-focused content plans, captions, campaign ideas, and content calendars that align with business goals and audience behavior." className="md:absolute md:top-[10px] md:right-[5%] lg:right-[10%] rotate-2 md:rotate-6" aosType="fade-left" aosDelay="100" pathLength={pathLength} containerRef={containerRef} />
          <TagCard number="02" title="Social Media Marketing" text="Creating high-performing social media campaigns for Instagram, YouTube, and other platforms with strong storytelling and audience engagement." className="md:absolute md:top-[450px] md:left-[5%] lg:left-[10%] -rotate-2 md:-rotate-6" aosType="fade-right" aosDelay="200" pathLength={pathLength} containerRef={containerRef} />
          <TagCard number="03" title="Creative Production" text="Directing shoots, writing scripts, handling cameras, and producing short-form video concepts from idea to execution." className="md:absolute md:top-[700px] md:right-[5%] lg:right-[15%] rotate-1 md:rotate-3" aosType="fade-left" aosDelay="300" pathLength={pathLength} containerRef={containerRef} />
          <TagCard number="04" title="Brand Growth & Coordination" text="Managing creative workflows, coordinating teams, communicating with clients, and turning marketing goals into strong brand visibility." className="md:absolute md:top-[1050px] md:left-[15%] lg:left-[25%] -rotate-1 md:-rotate-3" aosType="fade-right" aosDelay="400" pathLength={pathLength} containerRef={containerRef} />
